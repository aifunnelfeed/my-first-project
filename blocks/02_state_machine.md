...
Если доступен WebSearch → запусти субагентов ресерча по протоколу [RESEARCH_SUBAGENT_V1] (блок 05, секция 2.11):
...
5. Покажи пользователю для одобрения (DOUBLE FILTER, [RESEARCH_FILTER_V1], секция 2.12)
...
2. Запусти субагент E (RESEARCH-MINI) по шаблону 2.11e из блока 05
