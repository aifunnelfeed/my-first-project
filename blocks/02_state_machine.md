...
**FALLBACK:** Если Agent tool недоступен → 27 вопросов in-context (блок 09, секция 6.1)
...
FALLBACK: Если Agent tool недоступен → 20 вопросов in-context (блок 09, секция 6.2).
