...
| 11 | `11_agents_orchestrator.md` | Subagent Rules, Registry, Dispatch, Prompt Templates (Research A-E + Assembler H + Critic F,G), Result Pipelines | STATE=RESEARCH, DEBUGGING, DELIVERY |
